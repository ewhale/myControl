...
sys.path.append('/home/pi/scripts/myControl')
...
class Game():
        ...
        try:
            ...
            for console in consoleList:
                ...
                if console.getElementsByTagName('fullname'):
                    consoleObj['fullname'] = str(console.getElementsByTagName('fullname')[0].firstChile.nodeValue)
                ...
                if console.getElementsByTagName('extension'):
                    consoleObj['extension'] = str(console.getElementsByTagName('extension')[0].firstChild.nodeValue)
            ...
            for file in files:
                try:
                    ...
                    if consoleInfo['extensions'].find(extension) > -1:
                        # Loops through the gameList xml file for additional info
                        description = ''
                        playCount = 'NA'
                        fileName = file
    ...
    def runGame(gameInfo):
        try:
            ...
            return procs.runGame(gameInfo['console'], gameInfo['row'], 'web')
        except:
            return False